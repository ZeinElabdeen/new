                       ...
                       => Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) => OrderDetails(
                                  state: widget.state, order: widget.order))),
                      text: 'عرض',
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          Text(widget.order.placeName == null ? "": widget.order.placeName.length > 20 ? widget.order.placeName.substring(0,10) :widget.order.placeName ,
                              style:
