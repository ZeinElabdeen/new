...
import 'package:haat/src/Screens/DriverHome/Orders/rating.dart';

class EndedOrderCard extends StatefulWidget {
  final Order order;
  final int rate;

  const EndedOrderCard({Key key, this.order, this.rate}) : super(key: key);
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  Visibility(
                    visible: widget.rate != null && widget.order.rateState == false,
                    child: Container(
                      height: 30,
                      child: CustomBtn(
                        color: Theme.of(context).primaryColor,
                  ...
                  SizedBox(width: 5),
                  Text(
                   widget.order.orderPrice == null ? "0" :widget.order.orderPrice.toString(),
